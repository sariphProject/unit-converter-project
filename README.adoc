...
== Validation:
![Validation](https://github.com/sariphProject/unit-converter-project/blob/master/images/validation.png)

== Incorrect Result:
![Incorrect](https://github.com/sariphProject/unit-converter-project/blob/master/images/incorrectResult.png)

== Correct Result:
![Correct](https://github.com/sariphProject/unit-converter-project/blob/master/images/correctResult.png)
